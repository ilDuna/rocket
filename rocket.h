...
void rocket_send(uint16_t cid, uint16_t port, void *buffer, size_t length, pthread_mutex_t *lock);
void rocket_receive(uint16_t cid, uint16_t port, void *buffer, size_t length, pthread_mutex_t *lock);
